<template>
  <div
    class="cg3vi cax03 c5e9s cadmo cqmvi csb3e cxxfw c9cru c70js cfydh c5zj3"
  >
      ...
      <div class="c5a0p cew4t cfwvb c4a0m">
        <nav class="c8pgj">
          <ul class="c9gi4">
            ...
            <li class="cgktm">
              <nuxt-link :to="{ name: 'about' }" :class="getClass('about')">
            ...
            <li class="cgktm">
              <nuxt-link :to="{ name: 'resume' }" :class="getClass('resume')">
...
const defaultClass = "c4ugg csbvt cpvt7 cfup8 crnoq c5a0p c8pgj cfwvb cq87d outline-none";
const activeClass =
  "cgla5 cjg8k cj6ii cfup8 cdxil csov4 c5a0p chugl c53su c5c77 c8pgj cfwvb cq87d outline-none";

const getClass = (routeName) => {
  return route.name === routeName ? activeClass : defaultClass;
};
</script>
